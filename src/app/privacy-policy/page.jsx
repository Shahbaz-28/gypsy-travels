        ...
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-sm border border-slate-100 p-6 md:p-8">
          <div className="prose max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#0066a6] mb-4">1. Introduction</h2>
              <p className="mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#0066a6] mb-4">2. Information We Collect</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#0066a6] mb-4">3. How We Use Your Information</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#0066a6] mb-4">4. Disclosure of Your Information</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#0066a6] mb-4">5. Cookies and Tracking Technologies</h2>
              <p className="mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#0066a6] mb-4">6. Data Security</h2>
              <p>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#0066a6] mb-4">7. Your Data Protection Rights</h2>
              <p className="mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#0066a6] mb-4">8. Children's Privacy</h2>
              <p>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#0066a6] mb-4">9. Changes to This Privacy Policy</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#0066a6] mb-4">10. Contact Us</h2>
              <p className="mb-4">
