      ...
      <div className="container mx-auto px-4 py-32">
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-sm border border-slate-100 p-6 md:p-8">
          <div className="prose max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#0066a6] mb-4">2. Definitions</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#0066a6] mb-4">3. Booking and Payments</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#0066a6] mb-4">4. Cancellations and Refunds</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#0066a6] mb-4">5. Travel Insurance</h2>
              <p>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#0066a6] mb-4">6. Passport, Visa, and Health Requirements</h2>
              <p>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#0066a6] mb-4">7. Limitation of Liability</h2>
              <p>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#0066a6] mb-4">8. Changes to Terms and Conditions</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#0066a6] mb-4">9. Contact Information</h2>
